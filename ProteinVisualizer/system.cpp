...
bool System::Frame()
{
    ...
    auto rot = m_Input->GetMouseRotation();
    auto trans = m_Input->GetMouseTransition();
    float zoom = m_Input->GetZoom();

    result = m_Graphics->Frame(rot, trans, zoom);
    if (!result)
    {
        return false;
    }
...
LRESULT CALLBACK System::MessageHandler(HWND hwnd, UINT umsg, WPARAM wparam, LPARAM lparam)
{
    ...
    case WM_MOUSEWHEEL:
    {
        m_Input->WheelRotation((int)wparam);
        return 0;
    }
